...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    onePot: true,
    kidFriendly: false,
    ingredients: ["Risotto-Reis", "Getrocknete Pilze", "Zwiebel", "Bouillon", "Parmesan", "Olivenöl"],
    steps: [
  ...
  },
  {
    ...
    onePot: true,
    kidFriendly: true,
    ingredients: ["Kokosmilch", "Currypaste", "Reis", "Rüebli", "Zucchetti", "Peperoni", "Zwiebel"],
    steps: [
  ...
  },
  {
    ...
    onePot: false,
    kidFriendly: false,
    ingredients: ["Forelle (ausgenommen)", "Zitrone", "Kräuter", "Salz", "Butter"],
    steps: [
  ...
  },
  {
    ...
    onePot: true,
    kidFriendly: true,
    ingredients: ["Fertig-Pizzateig", "Tomatensauce", "Käse", "Salami oder Gemüse", "Olivenöl"],
    steps: [
  ...
  },
  {
    ...
    onePot: true,
    kidFriendly: true,
    ingredients: ["Bouillon", "Teigwaren", "Rüebli", "Sellerie", "Tomaten (Dose)", "Weisse Bohnen (Dose)", "Parmesan", "Öl"],
    steps: [
