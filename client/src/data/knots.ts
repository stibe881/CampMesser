...
export const knots: Knot[] = [
  {
    ...
    proTip: "Der Mastwurf hält nur unter Zug zuverlässig. Für dauerhafte Befestigungen mit einem halben Schlag sichern.",
  },
  {
    id: "palstek",
    name: "Palstek",
    ...
    proTip: "Nach dem Festziehen prüfen: Die Schlaufe darf sich unter Zug nicht verkleinern. Lässt sich auch nach starker Belastung leicht wieder öffnen.",
  },
  {
    id: "spannknoten",
    name: "Spannknoten",
    ...
    proTip: "Funktioniert am besten mit leicht rauen Leinen. Bei sehr glatten Dyneema-Schnüren eine zusätzliche Wicklung einbauen.",
  },
  {
    id: "kreuzknoten",
    name: "Kreuzknoten",
    ...
    proTip: "Merkspruch: «Links über rechts, rechts über links.» Für unterschiedlich dicke Seile stattdessen den Schotstek verwenden.",
  },
  {
    id: "schotstek",
    name: "Schotstek",
    ...
    proTip: "Für glatte oder stark unterschiedliche Seile den doppelten Schotstek binden (zweite Wicklung um die Bucht).",
  },
  {
    id: "prusik",
    name: "Prusikknoten",
    ...
    proTip: "Die Schlinge sollte etwa halb so dick sein wie das Hauptseil, sonst klemmt der Knoten nicht zuverlässig.",
  },
  {
    id: "achterknoten",
    name: "Achterknoten",
    ...
    proTip: "Lässt sich im Gegensatz zum einfachen Überhandknoten auch nach starker Belastung wieder gut lösen.",
  },
  {
    id: "fischerknoten",
    ...
    proTip: "Sehr sicher, aber nach starker Belastung kaum mehr zu öffnen – für dauerhafte Verbindungen gedacht.",
  },
];
