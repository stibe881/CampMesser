...
export const meteorShowers: MeteorShower[] = [
  {
    ...
    toDay: 12,
    zhr: 110,
    radiant: "Nordosten (unterhalb des Grossen Wagens)",
    tip: "Kurzes, scharfes Maximum von wenigen Stunden – die zweite Nachthälfte lohnt sich am meisten.",
  },
  {
    id: "lyriden",
    name: "Lyriden",
    ...
    toDay: 30,
    zhr: 18,
    radiant: "Osten (beim hellen Stern Wega)",
    tip: "Erster grösserer Strom im Frühling – gelegentlich helle Feuerkugeln.",
  },
  {
    id: "eta-aquariiden",
    name: "Eta-Aquariiden",
    ...
    toDay: 28,
    zhr: 50,
    radiant: "Osten, tief am Horizont",
    tip: "Staub des Halleyschen Kometen – am besten in den letzten zwei Stunden vor der Morgendämmerung.",
  },
  {
    id: "delta-aquariiden",
    name: "Delta-Aquariiden",
    peakMonth: 7,
    peakDay: 30,
    fromMonth: 7,
    fromDay: 12,
    ...
    zhr: 25,
    radiant: "Süden",
    tip: "Breites Maximum ohne Spitze – über mehrere Nächte gleich gut zu sehen.",
  },
  {
    id: "perseiden",
    name: "Perseiden",
    ...
    toDay: 24,
    zhr: 100,
    radiant: "Nordosten (Sternbild Perseus)",
    tip: "Der Klassiker der Camping-Saison: warme Nächte, hohe Raten – Liegestuhl raus ab 22 Uhr.",
  },
  {
    id: "draconiden",
    name: "Draconiden",
    ...
    toDay: 10,
    zhr: 10,
    radiant: "Nordwesten (Sternbild Drache)",
    tip: "Ausnahme-Strom: am besten am frühen Abend statt nach Mitternacht.",
  },
  {
    id: "orioniden",
    name: "Orioniden",
    ...
    toDay: 7,
    zhr: 20,
    radiant: "Osten (oberhalb des Orion)",
    tip: "Schnelle, oft helle Meteore – ebenfalls Staub des Halleyschen Kometen.",
  },
  {
    id: "leoniden",
    name: "Leoniden",
    ...
    toDay: 30,
    zhr: 15,
    radiant: "Osten (Sternbild Löwe)",
    tip: "Sehr schnelle Meteore mit langen Leuchtspuren – zweite Nachthälfte.",
  },
  {
    id: "geminiden",
    name: "Geminiden",
    ...
    toDay: 17,
    zhr: 150,
    radiant: "Osten (Sternbild Zwillinge)",
    tip: "Der stärkste Strom des Jahres – lohnt sich trotz Kälte schon ab dem frühen Abend.",
  },
  {
    id: "ursiden",
    name: "Ursiden",
    ...
    toDay: 26,
    zhr: 10,
    radiant: "Norden (Kleiner Wagen)",
    tip: "Kleiner, oft übersehener Strom in den längsten Nächten des Jahres.",
  },
];
