...
export const DRYING_ITEMS: DryingItem[] = [
  {
    id: "handtuch-duenn",
    label: "Reisehandtuch (Mikrofaser)",
    baseHours: 1.5,
    note: "Trocknet am schnellsten von allen.",
  },
  {
    id: "handtuch",
    label: "Frottee-Handtuch",
    baseHours: 4,
    note: "Dicke Schlaufen speichern viel Wasser.",
  },
  {
    id: "tshirt",
    label: "T-Shirt / Funktionsshirt",
    baseHours: 2,
    note: "Synthetik trocknet deutlich schneller als Baumwolle.",
  },
  {
    id: "jeans",
    label: "Jeans / dicke Hose",
    baseHours: 6,
    note: "Baumwolle hält Wasser hartnäckig fest.",
  },
  {
    id: "socken",
    label: "Socken (Wolle/Synthetik)",
    baseHours: 3,
    note: "Auf die Leine, nicht auf den Boden legen.",
  },
  {
    id: "zelt-aussen",
    label: "Zelt-Aussenhaut",
    baseHours: 1.5,
    note: "Aufgespannt trocknen lassen, nicht zusammengelegt.",
  },
  {
    id: "zelt-boden",
    label: "Zeltboden / Footprint",
    baseHours: 2.5,
    note: "Über die Leine hängen, beide Seiten trocknen lassen.",
  },
  {
    id: "schlafsack-synthetik",
    label: "Schlafsack (Kunstfaser)",
    baseHours: 5,
    note: "Offen und flach über zwei Leinen legen.",
  },
  {
    id: "schlafsack-daune",
    label: "Schlafsack (Daune)",
    baseHours: 10,
    note: "Daune trocknet sehr langsam – unbedingt Sonne nutzen.",
  },
  {
    id: "regenjacke",
    label: "Regenjacke",
    baseHours: 1,
    note: "Abtropfen lassen genügt meist.",
  },
  {
    id: "badehose",
    label: "Badesachen",
    baseHours: 2,
    note: "Nach dem Schwimmen gut auswringen.",
  },
];
